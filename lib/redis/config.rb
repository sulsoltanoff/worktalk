  ...
  module Config
    ...
    class << self
      ...
      def base_config
        {
          ...
          ssl_params: { verify_mode: Worktalk.redis_ssl_verify_mode },
      ...
      def sentinel_url_config(sentinel_url)
        ...
        sentinel_url_config = { host:, port: port || DEFAULT_SENTINEL_PORT }
      ...
      def sentinel_config
        ...
        base_config.merge({ url: master, sentinels: })
      end
    end
  end
end
