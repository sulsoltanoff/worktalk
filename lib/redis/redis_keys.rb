module WorktalkRedis::RedisKeys
  ## Inbox Keys
  ...
  WORKTALK_INSTALLATION_ONBOARDING = 'WORKTALK_INSTALLATION_ONBOARDING'.freeze
  LATEST_WORKTALK_VERSION = 'LATEST_WORKTALK_VERSION'.freeze
